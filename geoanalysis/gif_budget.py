...
for i in breakpointList:
    for j in timepointList: 
        fp_out = r"D:\Luyu\reliability\serious_reliability\pngs\Sep19Gif.gif"
        img_list = []
        for k in budgetList:
            fp_int = r"D:\Luyu\reliability\serious_reliability\pngs\Sep19t_" + str(k) + ".png"
            fp_in = r"D:\Luyu\reliability\serious_reliability\pngs\Sep19_" + str(k) + ".png"
