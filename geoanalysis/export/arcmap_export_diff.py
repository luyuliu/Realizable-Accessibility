...
symbologyLayer = r"D:\Luyu\reliability\serious_reliability\symbology_diff2.lyr"
    ...
    for j in timepointList:
        for k in budgetList:
            ...
            try:
                ...
                print("Field exists")
            arcpy.CalculateField_management(rawLayer, "symbol", "!diff_" + str(k) + "!", "PYTHON_9.3")
            ...
            arcpy.mapping.ExportToPNG(mxd, r"D:\Luyu\reliability\serious_reliability\pdfs\diff" + "\\" + fileLocation + "_" +  str(k)+ ".png")
